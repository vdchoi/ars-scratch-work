...
exp_sampling = function(n, x_list, function_temp) {
...
```{r}
hist(rejection_step(exp_sampling(10000, data, h), data, g), breaks = 20)
```
...
```{r}
hist(rejection_step(exp_sampling(10000, data2, h2), data2, g2), breaks = 30)
```
