...
- exp_sampling(), which returns a sample of "x" values from an input density  
\
...
This step calls init_abscissa(), to create a initial values with 20 tangent points equally spaced along the domain
